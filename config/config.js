...
var initGlobalConfigFolders = function (config, assets) {
  ...
  config.folders.client = getGlobbedPaths(path.join(process.cwd(), 'public/'), process.cwd().replace(new RegExp(/\\/g), '/'));
};
...
var initGlobalConfigFiles = function (config, assets) {
  ...
  config.files.client.js = getGlobbedPaths(assets.client.lib.js, 'public/').concat(getGlobbedPaths(assets.client.js, ['public/', 'public/']));

  // Setting Globbed css files
  config.files.client.css = getGlobbedPaths(assets.client.lib.css, 'public/').concat(getGlobbedPaths(assets.client.css, ['public/', 'public/']));
